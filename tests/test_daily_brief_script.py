...
def _run(fixture_dir, bridge_port=None, args=("--force",), now_override=None,
    ...
    if bridge_port is not None:
        ...
        # reaches the local stub (env already inherits PYTEST_CURRENT_TEST).
        # send-daily-brief is an allowlisted null-context caller; stub port
        # (not :3000) keeps the live-bridge tripwire dormant.
