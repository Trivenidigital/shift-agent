...
# Three planner-behavior tests removed with creative_planner (graduation
# commit 6): the pinned behaviors (config passthrough to the planner, planner
# non-materialization on combos, planner deferral before OCR) existed only in
# the always-dormant branch removed from facts.py.
