...
CONNECTOR_CANDIDATES: tuple[ConnectorCandidate, ...] = (
    ...
    ConnectorCandidate(
        ...
        freshness_days=14,
        notes="Preferred India payment connector path before custom Razorpay API integration.",
...
AGENT_CAPABILITIES: tuple[AgentCapability, ...] = (
    ...
    AgentCapability(2, "Catering Lead Agent", "no_key_ready", "WhatsApp inquiry/menu/proposal flow with local menu and owner approval.", "Owner uploads menus/photos/docs.", "Payment/POS/CRM connectors.", ("productivity/ocr-and-documents",), ("catering_dispatcher", "parse_catering_inquiry"), ("Stripe MCP", "Razorpay MCP", "Square MCP Server", "Zelle business rail", "Cash App Pay API", "Venmo business profile / PayPal Venmo integration", "Razorpay Payments API"), "payments/POS only in connected mode", "final quote/pricing/payment", "No pre-approval prices or booking confirmation."),
    ...
    AgentCapability(15, "Cash & AR Agent", "connected_required", "Manual ledger reminders only.", "Invoice/payment CSV upload.", "Stripe/Square/PayPal/QBO/bank.", (), ("cash_ar_dispatcher",), ("Stripe MCP", "Razorpay MCP", "Square MCP Server", "PayPal MCP Server", "Zelle business rail", "Cash App Pay API", "Venmo business profile / PayPal Venmo integration", "Razorpay Payments API", "Bank feed/Open Banking APIs", "Intuit QuickBooks Online MCP"), "payment/accounting rails", "all reminders and money actions", "No automated collections or payment movement."),
    ...
    AgentCapability(36, "Credit Customer & Temple Account", "manual_export", "Local ledger and WhatsApp statements.", "QBO/bank exports.", "QBO/bank/payment reconciliation.", (), (), ("Intuit QuickBooks Online MCP", "Razorpay MCP", "Bank feed/Open Banking APIs", "Zelle business rail", "Cash App Pay API", "Venmo business profile / PayPal Venmo integration", "Razorpay Payments API"), "accounting/payment oauth", "statements/collections", "No money movement."),
