...
import { Activity, AlertTriangle, Calendar, ChefHat, ClipboardList, Cog, FileText, Megaphone, MessageSquare, Phone, ScrollText, ShieldCheck, ShoppingBag, Users } from "lucide-react";
...
const NAV: { id: Section; label: string; icon: React.ComponentType<{ size?: number; className?: string }> }[] = [
  ...
  { id: "catering", label: "Catering Studio", icon: ChefHat },
